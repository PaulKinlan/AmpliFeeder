...
LoadTemplate = function() {
    $("#TemplateDump").load("Themes/" + ThemeName + "/" + ThemeName + ".detail.template.html", function() { TemplateLoaded() }).hide();
}

TemplateLoaded = function() {
    $('#Stylesheet').attr('href', "Themes/" + ThemeName + "/" + ThemeName + ".template.css");
...
LoadItem = function() {
    ...
    AjaxManager(parameterObject, "UIService.asmx/GetDetailItem", ItemLoaded, AjaxFailure);    
}
...
RenderChannelItem = function(item) {
    ...
    return ("<li><img src='Assets/img/icons/24/" + item.SourceTypeName + ".png' /><a href='detail.aspx?id=" + item.Id + "'>" + item.Title + "</a></li>");
}
